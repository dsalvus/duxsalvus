...
export default function AboutPage() {
  ...
  const experiences = [
    {
      ...
      period: "2020 - Present",
      description:
        "Developed and maintained web applications using React, and create graphic designs for social media content.",
    },
    // {
  ...
  const skills = [
    ...
    { category: "Frontend", items: ["React", "Next.js", "CSS", "Tailwind CSS"] },
    { category: "Tools", items: ["Figma", "Canva", "Adobe Photoshop"] },
  ...
  return (
    <div className="space-y-16">
      <section>
        ...
        {introComplete && (
          <Terminal
            text="Hello, I'm DUXSALVUS_DEV. A Frontend developer with a passion for AI, and creating immersive digital experiences. I specialize in building responsive, interactive, and accessible web applications with a focus on delivering seamless user experience. And also a keen interest in Graphic Design."
            typingSpeed={20}
                ...
                <div className="terminal-content">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      >
                        <Linkedin size={16} />
                        linkedin.com/in/dsalvus
                      </Link>
                    </div>
                    <div>
                      <p className="mb-1 text-primary">mail0:</p>
                      <Link
                        href="mailto:contact@dsalvus.com"
                        className="flex items-center gap-2 hover:text-primary transition-colors"
                      >
                        <Mail size={16} />
                        contact@dsalvus.com
